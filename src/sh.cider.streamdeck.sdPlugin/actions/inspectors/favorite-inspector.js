...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add the favorite section to baseInspector.globalSettings if it doesn't exist
    if (!baseInspector.globalSettings.favorite) {
        baseInspector.globalSettings.favorite = {
...
function handleSettingsUpdate(settings) {
    console.log('Favorite button settings updated:', settings);
...
function handleGlobalSettingsUpdate(globalSettings) {
    ...
    // If we have favorite settings in the global object, update our UI
    if (globalSettings.favorite) {
        // Synchronize the action settings with global favorite settings
        baseInspector.actionSettings = {...baseInspector.actionSettings, ...globalSettings.favorite};
